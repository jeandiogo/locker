...
XTR = -Wcast-align=strict -Wnull-dereference -Wredundant-tags -Wcast-qual -Wpacked -Wundef -Wold-style-cast -Wuseless-cast -Wfloat-equal -Wsuggest-final-types -Wsuggest-final-methods -Wsuggest-override
