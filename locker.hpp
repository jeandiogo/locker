...
// locker::lock<std::chrono::nanoseconds>(10, "a.lock");      //use template argument to change the unit of measurement
// locker::lock(1000, "a.lock", "b.lock");                    //also works for the variadic versions
// 
